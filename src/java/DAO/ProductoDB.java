...
public class ProductoDB {
    ...
    public static void insertarPrueba(Blob imagen) throws SNMPExceptions, SQLException, NamingException, ClassNotFoundException{
    
        String i= "insert into prueba  (foto) values(?)";
        
        AccesoDatos c =new AccesoDatos();
        PreparedStatement ps=c.getDbConn().prepareStatement(i);
        ps.setBlob(1, imagen);
        c.ejecutaSQL(i);
...
//    public static void insertarProducto(Producto p) throws SNMPExceptions{
//    String insert="exec InsertarProductos '"+p.getNombre()+"' ,'"   +p.getDescripcion()+"','"
//                  +p.getFoto()+"',"
//                  +p.getPrecio()+","
//                  +p.getCantidadMinimaVenta();
//                  AccesoDatos c=new AccesoDatos();
//                  c.ejecutaMatrizSQL(insert);
//    
//    }
//    
